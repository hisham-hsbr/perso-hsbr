...
<script src="{{ asset('frontend/jovie/assets/js/jquery.min.js') }}"></script>
<script src="{{ asset('frontend/jovie/assets/js/bootstrap.bundle.min.js') }}"></script>
<!-- Owl Carousel JS -->
<script src="{{ asset('frontend/jovie/assets/js/owl.carousel.min.js') }}"></script>
<!-- Nice Select JS -->
<script src="{{ asset('frontend/jovie/assets/js/jquery.nice-select.min.js') }}"></script>
<!-- Magnific Popup JS -->
<script src="{{ asset('frontend/jovie/assets/js/jquery.magnific-popup.min.js') }}"></script>
<!-- Subscriber Form JS -->
<script src="{{ asset('frontend/jovie/assets/js/jquery.ajaxchimp.min.js') }}"></script>
<!-- Form Velidation JS -->
<script src="{{ asset('frontend/jovie/assets/js/form-validator.min.js') }}"></script>
<!-- Contact Form -->
<script src="{{ asset('frontend/jovie/assets/js/contact-form-script.js') }}"></script>
<!-- Meanmenu JS -->
<script src="{{ asset('frontend/jovie/assets/js/meanmenu.js') }}"></script>
<!-- Custom JS -->
