...
@include('frontend.layouts.sections.banner_section')
<!-- Banner Section End -->
                        ...
                        <div class="col-lg-3">
                            <div class="thumb-img">
                                <a href="job-details.html">
                                    <img src="{{ asset('frontend/jovie/assets/img/company-logo/1.png') }}"
                                        alt="company logo">
                                </a>
                            </div>
                        </div>
                ...
                <div class="job-card">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-3">
                            <div class="thumb-img">
                                <a href="job-details.html">
                                    <img src="{{ asset('frontend/jovie/assets/img/company-logo/2.png') }}"
                                        alt="company logo">
                                </a>
                            </div>
                        </div>
                ...
                <div class="job-card">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-3">
                            <div class="thumb-img">
                                <a href="job-details.html">
                                    <img src="{{ asset('frontend/jovie/assets/img/company-logo/3.png') }}"
                                        alt="company logo">
                                </a>
                            </div>
                        </div>
                ...
                <div class="job-card">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-3">
                            <div class="thumb-img">
                                <a href="job-details.html">
                                    <img src="{{ asset('frontend/jovie/assets/img/company-logo/4.png') }}"
                                        alt="company logo">
                                </a>
                            </div>
                        </div>
                ...
                <div class="job-card">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-3">
                            <div class="thumb-img">
                                <a href="job-details.html">
                                    <img src="{{ asset('frontend/jovie/assets/img/company-logo/5.png') }}"
                                        alt="company logo">
                                </a>
                            </div>
                        </div>
                ...
                <div class="job-card">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-3">
                            <div class="thumb-img">
                                <a href="job-details.html">
                                    <img src="{{ asset('frontend/jovie/assets/img/company-logo/6.png') }}"
                                        alt="company logo">
                                </a>
                            </div>
                        </div>
        ...
        <div class="row justify-content-center">
                ...
                <div class="company-card">
                    <div class="company-logo">
                        <a href="job-grid.html">
                            <img src="{{ asset('frontend/jovie/assets/img/top-company/1.png') }}" alt="company logo">
                        </a>
                    </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="company-card">
                    <div class="company-logo">
                        <a href="job-grid.html">
                            <img src="{{ asset('frontend/jovie/assets/img/top-company/2.png') }}" alt="company logo">
                        </a>
                    </div>
                    <div class="company-text">
                        <h3>Trout Design</h3>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="company-card">
                    <div class="company-logo">
                        <a href="job-grid.html">
                            <img src="{{ asset('frontend/jovie/assets/img/top-company/3.png') }}" alt="company logo">
                        </a>
                    </div>
                    <div class="company-text">
                        <h3>Resland LTD</h3>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="company-card">
                    <div class="company-logo">
                        <a href="job-grid.html">
                            <img src="{{ asset('frontend/jovie/assets/img/top-company/4.png') }}" alt="company logo">
                        </a>
                    </div>
                    <div class="company-text">
                        <h3>Lawn Hopper</h3>
            ...
            <div class="p-0 col-lg-7">
                <div class="why-choose-text pt-100 pb-70">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-6">
                            <div class="media">
                                <i class="mr-3 flaticon-group align-self-center"></i>
                        ...
                        <div class="col-sm-6">
                            <div class="media">
                                <i class="mr-3 flaticon-research align-self-center"></i>
                                <div class="media-body">
                        ...
                        <div class="col-sm-6">
                            <div class="media">
                                <i class="mr-3 flaticon-discussion align-self-center"></i>
                                <div class="media-body">
                        ...
                        <div class="col-sm-6">
                            <div class="media">
                                <i class="mr-3 flaticon-recruitment align-self-center"></i>
                                <div class="media-body">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="looking-job">
                    <div class="media">
                        <i class='mr-3 flaticon-group align-self-start'></i>
                        <div class="media-body">
            ...
            <div class="col-md-6">
                <div class="recruiting-card">
                    <div class="media">
                        <i class='mr-3 flaticon-resume align-self-start'></i>
                        <div class="media-body">
        ...
        <div class="condidate-slider owl-carousel owl-theme">
            <div class="condidate-item">
                <div class="candidate-img">
                    <img src="{{ asset('frontend/jovie/assets/img/candidate/1.jpg') }}" alt="candidate image">
                </div>
            ...
            <div class="condidate-item">
                <div class="candidate-img">
                    <img src="{{ asset('frontend/jovie/assets/img/candidate/2.jpg') }}" alt="candidate image">
                </div>
                <div class="candidate-social">
                    <a href="https://www.facebook.com/login/" target="_blank"><i class='bx bxl-facebook'></i></a>
                    <a href="https://twitter.com/i/flow/login" target="_blank"><i class='bx bxl-twitter'></i></a>
            ...
            <div class="condidate-item">
                <div class="candidate-img">
                    <img src="{{ asset('frontend/jovie/assets/img/candidate/3.jpg') }}" alt="candidate image">
                </div>
                <div class="candidate-social">
                    <a href="https://www.facebook.com/login/" target="_blank"><i class='bx bxl-facebook'></i></a>
                    <a href="https://twitter.com/i/flow/login" target="_blank"><i class='bx bxl-twitter'></i></a>
            ...
            <div class="condidate-item">
                <div class="candidate-img">
                    <img src="{{ asset('frontend/jovie/assets/img/candidate/4.jpg') }}" alt="candidate image">
                </div>
                <div class="candidate-social">
                    <a href="https://www.facebook.com/login/" target="_blank"><i class='bx bxl-facebook'></i></a>
                    <a href="https://twitter.com/i/flow/login" target="_blank"><i class='bx bxl-twitter'></i></a>
        ...
        <div class="row justify-content-center">
            <div class="testimonial-slider owl-carousel owl-theme">
                <div class="testimonial-items">
                    <div class="row align-items-center justify-content-center">
                        <div class="p-0 col-lg-5 col-md-6">
                            <div class="testimonial-img">
                                <img src="{{ asset('frontend/jovie/assets/img/testimonial-img.jpg') }}"
                ...
                <div class="testimonial-items">
                    <div class="row align-items-center justify-content-center">
                        <div class="p-0 col-lg-5 col-md-6">
                            <div class="testimonial-img">
                                <img src="{{ asset('frontend/jovie/assets/img/testimonial-img-2.jpg') }}"
                                    alt="testimonial image">
                            </div>
                            <div class="testimonial-img-text">
                                <h3>John Doe</h3>
        ...
        <div class="row justify-content-center">
                ...
                <div class="blog-card">
                    <div class="blog-img">
                        <a href="blog-details.html">
                            <img src="{{ asset('frontend/jovie/assets/img/blog/1.jpg') }}" alt="blog image">
                        </a>
                    </div>
                    <div class="blog-text">
                        <ul>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="blog-card">
                    <div class="blog-img">
                        <a href="blog-details.html">
                            <img src="{{ asset('frontend/jovie/assets/img/blog/2.jpg') }}" alt="blog image">
                        </a>
                    </div>
                    <div class="blog-text">
                        <ul>
            ...
            <div class="col-lg-4 col-sm-6 ">
                <div class="blog-card">
                    <div class="blog-img">
                        <a href="blog-details.html">
                            <img src="{{ asset('frontend/jovie/assets/img/blog/3.jpg') }}" alt="blog image">
                        </a>
                    </div>
                    <div class="blog-text">
                        <ul>
